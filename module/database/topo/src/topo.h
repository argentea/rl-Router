...
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const WrongWaySegment& wws);
};
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const GridBoxOnLayer& gb);
};
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const ViaBox& vb);
};
